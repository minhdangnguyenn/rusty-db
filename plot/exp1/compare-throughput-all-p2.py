...
CONFIGS = [
    ("Cache, Uniform", NAVY, "o", "csv/p2/exp1/cache/l/uniform"),
    ("Cache, Zipfian", GREEN, "^", "csv/p2/exp1/cache/l/zipf"),
    ("No cache, Uniform", LIGHT_RED, "s", "csv/p2/exp1/no-cache/l/uniform"),
    ("No cache, Zipfian", ORANGE, "D", "csv/p2/exp1/no-cache/l/zipf"),
]
...
def main():
    ...
    out_path = "charts/p2/exp1/throughput-all-large.png"
